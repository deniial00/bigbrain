...
Produce a phased implementation plan grounded in the **Principles** section of the `bigbrain` skill. The plan is the deliverable. Do not implement.
...
Read the **Principles** section of the `bigbrain` skill end to end, and the leaf `principle-*` skills it indexes. The principles govern every plan decision; cross-link them.
...
In the overview, name which bigbrain non-negotiables the implementer must apply, by name:
