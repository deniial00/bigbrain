...
The **bigbrain-core** skill shows the shape. Read it for granularity. Don't copy its content; the user's rules are not the same as bigbrain-core's.
...
- The **bigbrain-core** skill: example of the output shape.
