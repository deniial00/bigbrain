...
The **bigbrain** skill shows the shape. Read it for granularity. Don't copy its content; the user's rules are not the same as bigbrain's.
...
- The **bigbrain** skill: example of the output shape.
